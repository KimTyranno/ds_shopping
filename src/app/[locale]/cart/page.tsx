...
const dummyCartItems: CartItem[] = [
  {
    ...
    image: '/placeholder.svg?height=100&width=100&text=Galaxy+S24',
    quantity: 1,
    selected: true,
    brand: '삼성',
  ...
  },
  {
    ...
    image: '/placeholder.svg?height=100&width=100&text=Cotton+Shirt',
    quantity: 2,
    selected: true,
    brand: '유니클로',
  ...
  },
  {
    ...
    image: '/placeholder.svg?height=100&width=100&text=Nike+AirMax',
    quantity: 1,
    selected: false,
    brand: '나이키',
